...
| `people` | `src/content/people/` | No (roles + quotes inline per locale) | name, roleEn, roleDe, coverImage, showInFaces, order, showAsTestimonial, testimonialOrder, quoteEn, quoteDe |
