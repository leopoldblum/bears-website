...
File naming: "YYYY MM DD title.mdx" or ".mdx"
Frontmatter:
...
File naming within tier: "NN-name.mdx" (numeric prefix = display order)
Frontmatter:
...
File naming: "NN-name.mdx" (numeric prefix = display order)
Frontmatter:
...
File naming: "NN-name.mdx" (numeric prefix = display order, sorted numerically not alphabetically)
Two types:
