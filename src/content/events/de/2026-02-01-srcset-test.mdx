...
### Kleine Breite (400px)
<Img src={testImage} alt="Test bei 400px Breite" width="400px" />

### Mittlere Breite (800px)
<Img src={testImage} alt="Test bei 800px Breite" width="800px" />

### Prozentuale Breite (50%)
<Img src={testImage} alt="Test bei 50% Breite" width="50%" />

### Standard (keine Breite angegeben)
<Img src={testImage} alt="Test mit voller Standardbreite" />
...
<Marquee speed={100} gap="1rem" height="xl" direction="left">
  <Img src={testImage} alt="Marquee-Bild 1" enableClickToEnlarge={true} />
  <Img src={testImage2} alt="Marquee-Bild 2" enableClickToEnlarge={false} />
  <Img src={testImage3} alt="Marquee-Bild 3" enableClickToEnlarge={false} />
  <Img src={testImage4} alt="Marquee-Bild 4" enableClickToEnlarge={false} />
  <Img src={testImage5} alt="Marquee-Bild 5" enableClickToEnlarge={false} />
  <Img src={testImage6} alt="Marquee-Bild 6" enableClickToEnlarge={false} />
</Marquee>
...
<Carousel autoScroll={true} autoScrollInterval={4000} showArrows={true} showDots={true} height="lg">
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src={testImage} alt="Carousel-Folie 1" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src={testImage2} alt="Carousel-Folie 2" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src={testImage3} alt="Carousel-Folie 3" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src={testImage4} alt="Carousel-Folie 4" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src={testImage5} alt="Carousel-Folie 5" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src={testImage6} alt="Carousel-Folie 6" class="rounded-lg" />
  </div>
</Carousel>
