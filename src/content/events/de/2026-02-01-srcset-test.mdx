...
### Kleine Breite (400px)
<Img src="/src/assets/projects/project-1.jpg" alt="Test bei 400px Breite" width="400px" />

### Mittlere Breite (800px)
<Img src="/src/assets/projects/project-1.jpg" alt="Test bei 800px Breite" width="800px" />

### Prozentuale Breite (50%)
<Img src="/src/assets/projects/project-1.jpg" alt="Test bei 50% Breite" width="50%" />

### Standard (keine Breite angegeben)
<Img src="/src/assets/projects/project-1.jpg" alt="Test mit voller Standardbreite" />
...
<Marquee speed={100} gap="1rem" height="xl" direction="left">
  <Img src="/src/assets/projects/project-1.jpg" alt="Marquee-Bild 1" enableClickToEnlarge={true} />
  ...
  <Img src="/src/assets/projects/project-4.jpg" alt="Marquee-Bild 4" enableClickToEnlarge={false} />
  <Img src="/src/assets/projects/project-5.jpg" alt="Marquee-Bild 5" enableClickToEnlarge={false} />
...
<Carousel autoScroll={true} autoScrollInterval={4000} showArrows={true} showDots={true} height="lg">
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src="/src/assets/projects/project-1.jpg" alt="Carousel-Folie 1" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
  ...
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src="/src/assets/projects/project-4.jpg" alt="Carousel-Folie 4" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src="/src/assets/projects/project-5.jpg" alt="Carousel-Folie 5" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
