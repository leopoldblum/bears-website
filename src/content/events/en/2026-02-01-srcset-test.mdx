...
### Small Width (400px)
<Img src="/src/assets/projects/2026-01-15-high-altitude-balloon/project-1.jpg" alt="Test at 400px width" width="400px" />

### Medium Width (800px)
<Img src="/src/assets/projects/2026-01-15-high-altitude-balloon/project-1.jpg" alt="Test at 800px width" width="800px" />

### Percentage Width (50%)
<Img src="/src/assets/projects/2026-01-15-high-altitude-balloon/project-1.jpg" alt="Test at 50% width" width="50%" />

### Default (No width specified)
<Img src="/src/assets/projects/2026-01-15-high-altitude-balloon/project-1.jpg" alt="Test with default full width" />
...
<Marquee speed={100} gap="1rem" height="xl" direction="left">
  <Img src="/src/assets/projects/2026-01-15-high-altitude-balloon/project-1.jpg" alt="Marquee image 1" enableClickToEnlarge={true} />
  ...
  <Img src="/src/assets/projects/2025-12-10-cubesat-tracking/project-4.jpg" alt="Marquee image 4" enableClickToEnlarge={false} />
  <Img src="/src/assets/projects/2026-09-12-test-rover/project-5.jpg" alt="Marquee image 5" enableClickToEnlarge={false} />
...
<Carousel autoScroll={true} autoScrollInterval={4000} showArrows={true} showDots={true} height="lg">
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src="/src/assets/projects/2026-01-15-high-altitude-balloon/project-1.jpg" alt="Carousel slide 1" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
  ...
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src="/src/assets/projects/2025-12-10-cubesat-tracking/project-4.jpg" alt="Carousel slide 4" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src="/src/assets/projects/2026-09-12-test-rover/project-5.jpg" alt="Carousel slide 5" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
