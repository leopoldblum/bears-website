...
date: 2026-02-01
categoryEvent: "other"
tags: ["test", "srcset", "responsive-images", "Img"]
isDraft: false
---
...
### Small Width (400px)
<Img src={testImage} alt="Test at 400px width" width="400px" />

### Medium Width (800px)
<Img src={testImage} alt="Test at 800px width" width="800px" />

### Percentage Width (50%)
<Img src={testImage} alt="Test at 50% width" width="50%" />

### Default (No width specified)
<Img src={testImage} alt="Test with default full width" />
...
<Marquee speed={100} gap="1rem" height="xl" direction="left">
  ...
  <Img src={testImage2} alt="Marquee image 2" enableClickToEnlarge={false} />
  <Img src={testImage3} alt="Marquee image 3" enableClickToEnlarge={false} />
  <Img src={testImage4} alt="Marquee image 4" enableClickToEnlarge={false} />
  <Img src={testImage5} alt="Marquee image 5" enableClickToEnlarge={false} />
  <Img src={testImage6} alt="Marquee image 6" enableClickToEnlarge={false} />
</Marquee>
...
<Carousel autoScroll={true} autoScrollInterval={4000} showArrows={true} showDots={true} height="lg">
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src={testImage} alt="Carousel slide 1" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src={testImage2} alt="Carousel slide 2" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src={testImage3} alt="Carousel slide 3" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src={testImage4} alt="Carousel slide 4" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src={testImage5} alt="Carousel slide 5" class="rounded-lg" />
  </div>
  <div class="w-full h-full flex items-center justify-center p-4">
    <Img src={testImage6} alt="Carousel slide 6" class="rounded-lg" />
  </div>
</Carousel>
