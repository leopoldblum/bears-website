...
<Marquee speed={100} gap="1.5rem" height="sm" pauseOnHover={true}>
  <Img src={project1} alt="Aufbau eines Schwerelosigkeitsexperiments" class="rounded-lg" />
  <Img src={project2} alt="Außenansicht der Fallturmanlage" class="rounded-lg" />
  <Img src={project3} alt="Kristallwachstumsproben unter Analyse" class="rounded-lg" />
  <Img src={project4} alt="Fluiddynamik-Experiment in Durchführung" class="rounded-lg" />
  <Img src={project5} alt="Team bereitet Nutzlast für Falltest vor" class="rounded-lg" />
  <Img src={project6} alt="Hochgeschwindigkeitskamera erfasst Schwerelosigkeitsphänomene" class="rounded-lg" />
</Marquee>
</Right>
</SideBySide>
...
<Center>
  <Img src={project1} alt="Aufbau eines Schwerelosigkeitsexperiments" width="30%" loading="eager" />
</Center>
### Galerie der Forschungshighlights

<Marquee speed={60} gap="1.5rem" height="md" pauseOnHover={false}>
  <Img src={project1} alt="Aufbau eines Schwerelosigkeitsexperiments" class="rounded-lg" enableClickToEnlarge={false} />
  <Img src={project2} alt="Außenansicht der Fallturmanlage" class="rounded-lg" enableClickToEnlarge={false}/>
  <Img src={project3} alt="Kristallwachstumsproben unter Analyse" class="rounded-lg" enableClickToEnlarge={false}/>
  <Img src={project4} alt="Fluiddynamik-Experiment in Durchführung" class="rounded-lg" enableClickToEnlarge={false}/>
  <Img src={project5} alt="Team bereitet Nutzlast für Falltest vor" class="rounded-lg" />
  <Img src={project6} alt="Hochgeschwindigkeitskamera erfasst Schwerelosigkeitsphänomene" class="rounded-lg" />
</Marquee>
