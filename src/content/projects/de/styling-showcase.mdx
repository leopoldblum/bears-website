...
<Img src="/src/assets/projects/high-altitude-balloon/project-1.jpg" alt="Projektpräsentation in voller Breite" width="100%" loading="eager" />

### Bild mit 80% Breite
<Img src="/src/assets/projects/project-2.jpg" alt="Bild mit 80% Breite" width="80%" />

### Bild mit 60% Breite
<Img src="/src/assets/projects/project-3.jpg" alt="Bild mit 60% Breite" width="60%" />
...
<ImageGrid
  ...
  aspectRatio='square'
  images={[
    { image: "/src/assets/projects/high-altitude-balloon/project-1.jpg", alt: "Projekt 1 Rasterbeispiel" },
    { image: "/src/assets/projects/project-2.jpg", alt: "Projekt 2 Rasterbeispiel" },
    { image: "/src/assets/projects/project-3.jpg", alt: "Projekt 3 Rasterbeispiel" },
    { image: "/src/assets/projects/cubesat-tracking/project-4.jpg", alt: "Projekt 4 Rasterbeispiel" },
    { image: "/src/assets/projects/test-rover/project-5.jpg", alt: "Projekt 5 Rasterbeispiel" },
    { image: "/src/assets/projects/project-6.jpg", alt: "Projekt 6 Rasterbeispiel" }
  ]}
/>
...
<Carousel showArrows={true} showDots={true} height="md">
  <Img src="/src/assets/projects/high-altitude-balloon/project-1.jpg" alt="Projekt 1" class="rounded-lg" />
  <Img src="/src/assets/projects/project-2.jpg" alt="Projekt 2" class="rounded-lg" />
  <Img src="/src/assets/projects/project-3.jpg" alt="Projekt 3" class="rounded-lg" />
  <Img src="/src/assets/projects/cubesat-tracking/project-4.jpg" alt="Projekt 4" class="rounded-lg" />
  <Img src="/src/assets/projects/test-rover/project-5.jpg" alt="Projekt 5" class="rounded-lg" />
  <Img src="/src/assets/projects/project-6.jpg" alt="Projekt 6" class="rounded-lg" />
</Carousel>
...
<Marquee speed={80} gap="1.5rem" height="md" direction='left'>
  <Img src="/src/assets/projects/high-altitude-balloon/project-1.jpg" alt="Projekt 1 Showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/project-2.jpg" alt="Projekt 2 Showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/project-3.jpg" alt="Projekt 3 Showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/cubesat-tracking/project-4.jpg" alt="Projekt 4 Showcase" class="rounded-lg" />
</Marquee>
...
<Marquee speed={180} gap="2rem" height="sm" direction="right">
  ...
  <Img src="/src/assets/projects/project-3.jpg" alt="Projekt 3 Showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/cubesat-tracking/project-4.jpg" alt="Projekt 4 Showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/test-rover/project-5.jpg" alt="Projekt 5 Showcase" class="rounded-lg" />
</Marquee>
