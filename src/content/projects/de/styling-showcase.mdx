...
<Button variant="primary" size="standard" href="#buttons" content="Standard Primär" />

<Button variant="primary" size="large" content="Großer Primärer Button" />

### Sekundäre Buttons

<Button variant="secondary" size="standard" content="Standard Sekundär" />

<Button variant="secondary" size="large" content="Großer Sekundärer Button" />

### Inverse Buttons

<Button variant="inverse" size="standard" content="Standard Invers" />

<Button variant="inverse" size="large" content="Großer Inverser Button" />
...
<Img src="/src/assets/projects/high-altitude-balloon/project-1.jpg" alt="Projektpräsentation in voller Breite" width="100%" />
...
<Button variant="primary" size="standard" content="Farbe in Aktion sehen" />
