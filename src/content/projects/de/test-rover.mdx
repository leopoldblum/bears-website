...
<Button variant="primary" size="large" href="/contact" content="Experimentvorschlag einreichen" />
...
<Center>
  <Img src="/src/assets/projects/high-altitude-balloon/project-1.jpg" alt="Aufbau eines Schwerelosigkeitsexperiments" width="30%" />
</Center>
...
<Carousel showArrows={true} showDots={true} height="sm">
  <Callout title="Kristallwachstumsstudie">
  ...
  <Callout title="Verbrennungsforschung">
