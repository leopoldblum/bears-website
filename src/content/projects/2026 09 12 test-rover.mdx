...
<Marquee speed={100} gap="1.5rem" height="sm" pauseOnHover={true}>
  <Img src={project1} alt="Microgravity experiment setup" class="rounded-lg" />
  <Img src={project2} alt="Drop tower facility exterior" class="rounded-lg" />
  <Img src={project3} alt="Crystal growth samples under analysis" class="rounded-lg" />
  <Img src={project4} alt="Fluid dynamics experiment in progress" class="rounded-lg" />
  <Img src={project5} alt="Team preparing payload for drop test" class="rounded-lg" />
  <Img src={project6} alt="High-speed camera capturing microgravity phenomena" class="rounded-lg" />
</Marquee>
</Right>
</SideBySide>
...
<Center>
  <Img src={project1} alt="Microgravity experiment setup" width="30%" loading="eager" />
</Center>
### Research Highlights Gallery

<Marquee speed={60} gap="1.5rem" height="md" pauseOnHover={false}>
  <Img src={project1} alt="Microgravity experiment setup" class="rounded-lg" enableClickToEnlarge={false} />
  <Img src={project2} alt="Drop tower facility exterior" class="rounded-lg" enableClickToEnlarge={false}/>
  <Img src={project3} alt="Crystal growth samples under analysis" class="rounded-lg" enableClickToEnlarge={false}/>
  <Img src={project4} alt="Fluid dynamics experiment in progress" class="rounded-lg" enableClickToEnlarge={false}/>
  <Img src={project5} alt="Team preparing payload for drop test" class="rounded-lg" />
  <Img src={project6} alt="High-speed camera capturing microgravity phenomena" class="rounded-lg" />
</Marquee>
