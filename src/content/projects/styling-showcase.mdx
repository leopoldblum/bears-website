...
<ImageGrid cols={2}>
  <Img src={project1} alt="Project 1 grid example" class="rounded-lg" />
  <Img src={project2} alt="Project 2 grid example" class="rounded-lg" />
  <Img src={project3} alt="Project 3 grid example" class="rounded-lg" />
  <Img src={project4} alt="Project 4 grid example" class="rounded-lg" />
  <Img src={project5} alt="Project 5 grid example" class="rounded-lg" />
  <Img src={project6} alt="Project 6 grid example" class="rounded-lg" />
</ImageGrid>
...
<Carousel showArrows={true} showDots={true} minHeight="min-h-96">
