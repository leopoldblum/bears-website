...
import SquareImageGrid from '@components/reusable/SquareImageGrid.astro'
...
<SquareImageGrid
  ...
  aspectRatio='square'
  images={[
    { image: project1, alt: "Project 1 grid example" },
    { image: project2, alt: "Project 2 grid example" },
    { image: project3, alt: "Project 3 grid example" },
    { image: project4, alt: "Project 4 grid example" },
    { image: project5, alt: "Project 5 grid example" },
    { image: project6, alt: "Project 6 grid example" }
  ]}
/>
