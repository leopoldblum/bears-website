...
The marquee creates a scrolling image gallery that's perfect for showcasing multiple projects:

<Marquee
  images={[
    { src: project1, alt: "Project 1 showcase" },
    { src: project2, alt: "Project 2 showcase" },
    { src: project3, alt: "Project 3 showcase" },
    { src: project4, alt: "Project 4 showcase" },
    { src: project5, alt: "Project 5 showcase" },
    { src: project6, alt: "Project 6 showcase" },
  ]}
  duration={20}
  gap="2rem"
  pauseOnHover={true}
...
<Marquee
  images={[
    { src: project1, alt: "Featured project 1" },
    { src: project2, alt: "Featured project 2" },
    { src: project3, alt: "Featured project 3" },
  ]}
  duration={15}
  gap="1rem"
  pauseOnHover={true}
