...
### Full Width Image
<Img_better src={project1} alt="Full width project showcase" width="100%" loading="eager" />

### 80% Width Image
<Img_better src={project2} alt="80% width image" width="80%" />

### 60% Width Image
<Img_better src={project3} alt="60% width image" width="60%" />
...
<ImageGrid cols={2}>
  <Img_better src={project1} alt="Project 1 grid example" class="rounded-lg" />
  <Img_better src={project2} alt="Project 2 grid example" class="rounded-lg" />
  <Img_better src={project3} alt="Project 3 grid example" class="rounded-lg" />
  <Img_better src={project4} alt="Project 4 grid example" class="rounded-lg" />
  <Img_better src={project5} alt="Project 5 grid example" class="rounded-lg" />
  <Img_better src={project6} alt="Project 6 grid example" class="rounded-lg" />
</ImageGrid>
...
<Carousel_better showArrows={true} showDots={true} height="md">
  <Img_better src={project1} alt="Project 1" class="rounded-lg" />
  <Img_better src={project2} alt="Project 2" class="rounded-lg" />
  <Img_better src={project3} alt="Project 3" class="rounded-lg" />
  <Img_better src={project4} alt="Project 4" class="rounded-lg" />
  <Img_better src={project5} alt="Project 5" class="rounded-lg" />
  <Img_better src={project6} alt="Project 6" class="rounded-lg" />
</Carousel_better>
...
<Carousel_better showArrows={true} showDots={true} height="sm">
...
<Marquee_better speed={80} gap="1.5rem" height="md" direction='left'>
  <Img_better src={project1} alt="Project 1 showcase" class="rounded-lg" />
  <Img_better src={project2} alt="Project 2 showcase" class="rounded-lg" />
  <Img_better src={project3} alt="Project 3 showcase" class="rounded-lg" />
  <Img_better src={project4} alt="Project 4 showcase" class="rounded-lg" />
</Marquee_better>
...
<Marquee_better speed={180} gap="2rem" height="sm" direction="right">
  <Img_better src={project1} alt="Project 1 showcase" class="rounded-lg" />
  <Img_better src={project2} alt="Project 2 showcase" class="rounded-lg" />
  <Img_better src={project3} alt="Project 3 showcase" class="rounded-lg" />
  <Img_better src={project4} alt="Project 4 showcase" class="rounded-lg" />
  <Img_better src={project5} alt="Project 5 showcase" class="rounded-lg" />
</Marquee_better>
