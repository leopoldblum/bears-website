...
- Droplet dynamics and coalescence
  ...
  />
    ...
    <Right>
<Marquee_better speed={100} gap="1.5rem" height="sm" pauseOnHover={true}>
  <Img_better src={project1} alt="Microgravity experiment setup" class="rounded-lg" />
  <Img_better src={project2} alt="Drop tower facility exterior" class="rounded-lg" />
  <Img_better src={project3} alt="Crystal growth samples under analysis" class="rounded-lg" />
  <Img_better src={project4} alt="Fluid dynamics experiment in progress" class="rounded-lg" />
  <Img_better src={project5} alt="Team preparing payload for drop test" class="rounded-lg" />
  <Img_better src={project6} alt="High-speed camera capturing microgravity phenomena" class="rounded-lg" />
</Marquee_better>
</Right>
</SideBySide>
...
<Center>
  <Img_better src={project1} alt="Microgravity experiment setup" width="30%" loading="eager" />
</Center>
### Research Highlights Gallery

<Marquee_better speed={60} gap="1.5rem" height="md" pauseOnHover={false}>
  <Img_better src={project1} alt="Microgravity experiment setup" class="rounded-lg" enableClickToEnlarge={false} />
  <Img_better src={project2} alt="Drop tower facility exterior" class="rounded-lg" enableClickToEnlarge={false}/>
  <Img_better src={project3} alt="Crystal growth samples under analysis" class="rounded-lg" enableClickToEnlarge={false}/>
  <Img_better src={project4} alt="Fluid dynamics experiment in progress" class="rounded-lg" enableClickToEnlarge={false}/>
  <Img_better src={project5} alt="Team preparing payload for drop test" class="rounded-lg" />
  <Img_better src={project6} alt="High-speed camera capturing microgravity phenomena" class="rounded-lg" />
</Marquee_better>
