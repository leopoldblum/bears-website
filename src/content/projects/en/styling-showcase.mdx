...
### Full Width Image
<Img src={project1} alt="Full width project showcase" width="100%" loading="eager" />
...
<Carousel showArrows={true} showDots={true} height="md">
  <Img src={project1} alt="Project 1" class="rounded-lg" />
  <Img src={project2} alt="Project 2" class="rounded-lg" />
  <Img src={project3} alt="Project 3" class="rounded-lg" />
  <Img src={project4} alt="Project 4" class="rounded-lg" />
  <Img src={project5} alt="Project 5" class="rounded-lg" />
  <Img src={project6} alt="Project 6" class="rounded-lg" />
</Carousel>
