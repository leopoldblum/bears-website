...
### Full Width Image
<Img src="/src/assets/projects/high-altitude-balloon/project-1.jpg" alt="Full width project showcase" width="100%" loading="eager" />

### 80% Width Image
<Img src="/src/assets/projects/project-2.jpg" alt="80% width image" width="80%" />

### 60% Width Image
<Img src="/src/assets/projects/project-3.jpg" alt="60% width image" width="60%" />
...
<ImageGrid
  ...
  aspectRatio='square'
  images={[
    { image: "/src/assets/projects/high-altitude-balloon/project-1.jpg", alt: "Project 1 grid example" },
    { image: "/src/assets/projects/project-2.jpg", alt: "Project 2 grid example" },
    { image: "/src/assets/projects/project-3.jpg", alt: "Project 3 grid example" },
    { image: "/src/assets/projects/cubesat-tracking/project-4.jpg", alt: "Project 4 grid example" },
    { image: "/src/assets/projects/test-rover/project-5.jpg", alt: "Project 5 grid example" },
    { image: "/src/assets/projects/project-6.jpg", alt: "Project 6 grid example" }
  ]}
/>
...
<Carousel showArrows={true} showDots={true} height="md">
  <Img src="/src/assets/projects/high-altitude-balloon/project-1.jpg" alt="Project 1" class="rounded-lg" />
  <Img src="/src/assets/projects/project-2.jpg" alt="Project 2" class="rounded-lg" />
  <Img src="/src/assets/projects/project-3.jpg" alt="Project 3" class="rounded-lg" />
  <Img src="/src/assets/projects/cubesat-tracking/project-4.jpg" alt="Project 4" class="rounded-lg" />
  <Img src="/src/assets/projects/test-rover/project-5.jpg" alt="Project 5" class="rounded-lg" />
  <Img src="/src/assets/projects/project-6.jpg" alt="Project 6" class="rounded-lg" />
</Carousel>
...
<Marquee speed={80} gap="1.5rem" height="md" direction='left'>
  <Img src="/src/assets/projects/high-altitude-balloon/project-1.jpg" alt="Project 1 showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/project-2.jpg" alt="Project 2 showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/project-3.jpg" alt="Project 3 showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/cubesat-tracking/project-4.jpg" alt="Project 4 showcase" class="rounded-lg" />
</Marquee>
...
<Marquee speed={180} gap="2rem" height="sm" direction="right">
  ...
  <Img src="/src/assets/projects/project-3.jpg" alt="Project 3 showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/cubesat-tracking/project-4.jpg" alt="Project 4 showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/test-rover/project-5.jpg" alt="Project 5 showcase" class="rounded-lg" />
</Marquee>
