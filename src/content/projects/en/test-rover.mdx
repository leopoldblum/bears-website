...
<Button variant="primary" size="large" href="/contact" content="Submit Experiment Proposal" />
...
<Center>
  <Img src="/src/assets/projects/high-altitude-balloon/project-1.jpg" alt="Microgravity experiment setup" width="30%" />
</Center>
...
<Carousel showArrows={true} showDots={true} height="sm">
  <Callout title="Crystal Growth Study">
  ...
  <Callout title="Combustion Research">
