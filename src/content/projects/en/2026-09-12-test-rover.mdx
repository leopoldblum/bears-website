...
<Marquee speed={100} gap="1.5rem" height="sm" pauseOnHover={true}>
  <Img src="/src/assets/projects/2026-01-15-high-altitude-balloon/project-1.jpg" alt="Microgravity experiment setup" class="rounded-lg" />
  ...
  <Img src="/src/assets/projects/2025-12-10-cubesat-tracking/project-4.jpg" alt="Fluid dynamics experiment in progress" class="rounded-lg" />
  <Img src="/src/assets/projects/2026-09-12-test-rover/project-5.jpg" alt="Team preparing payload for drop test" class="rounded-lg" />
...
<Center>
  <Img src="/src/assets/projects/2026-01-15-high-altitude-balloon/project-1.jpg" alt="Microgravity experiment setup" width="30%" loading="eager" />
</Center>
### Research Highlights Gallery

<Marquee speed={60} gap="1.5rem" height="md" pauseOnHover={false}>
  <Img src="/src/assets/projects/2026-01-15-high-altitude-balloon/project-1.jpg" alt="Microgravity experiment setup" class="rounded-lg" enableClickToEnlarge={false} />
  ...
  <Img src="/src/assets/projects/2025-12-10-cubesat-tracking/project-4.jpg" alt="Fluid dynamics experiment in progress" class="rounded-lg" enableClickToEnlarge={false}/>
  <Img src="/src/assets/projects/2026-09-12-test-rover/project-5.jpg" alt="Team preparing payload for drop test" class="rounded-lg" />
  <Img src="/src/assets/projects/project-6.jpg" alt="High-speed camera capturing microgravity phenomena" class="rounded-lg" />
</Marquee>
